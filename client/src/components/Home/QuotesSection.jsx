...
import css from "../../styles/Home/QuotesSection.module.scss"
        ...
        <section className={css.section7}>
            <div className={`${css.container_parent} container`}>
                ...
                <div className={css.Quotes} >
                    ...
                    <figure className={`${css.quote}`} style={{ gridArea: "quote_1" }}>
                    ...
                    <figure className={`${css.quote}`} style={{ gridArea: "quote_2" }}>
                    ...
                    <figure className={`${css.quote} `} style={{ gridArea: "quote_3" }}>
                    ...
                    <figure className={`${css.quote} }`} style={{ gridArea: "quote_4" }}>
                    ...
                    <figure className={`${css.quote} `} style={{ gridArea: "quote_5" }}>
                    ...
                    <figure className={`${css.quote} ${css.quote_6}`} style={{ gridArea: "quote_6" }}>
